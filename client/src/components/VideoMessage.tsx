...
export function VideoMessage({ messageId, caption }: VideoMessageProps) {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center w-64 h-36 bg-muted/30 rounded-lg">
  ...
  if (error || !data) {
    return (
      <div className="flex flex-col items-center justify-center w-64 h-36 bg-muted/30 rounded-lg">
